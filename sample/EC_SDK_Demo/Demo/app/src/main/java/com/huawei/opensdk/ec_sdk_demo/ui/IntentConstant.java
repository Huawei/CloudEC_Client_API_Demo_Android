...
public class IntentConstant
{
    ...
    public static final String VIDEO_CONF_ACTIVITY_ACTION = "android.intent.action.conf_video_activity";
    ...
    public static final String SYSTEM_HEAD_SELETE_ACTIVITY_ACTION = "android.intent.action.im_system_head_activity";
